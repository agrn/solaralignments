...
let solar jd =
  ...
  let t = j2000 jd in
  let l0 = (280.46645 +. 36000.76983 *. t +. 0.0003032 *. (t ** 2.)) %. 360. in (* 24.2 *)
  let m = (357.52910 +. 35999.05030 *. t +. 0.0001559 *. (t ** 2.) -. 0.00000048 *. (t ** 3.)) %. 360. in (* 24.3 *)

  let c = (1.914600 -. 0.004817 *. t -. 0.000014 *. (t ** 2.)) *. (dsin m) +.
